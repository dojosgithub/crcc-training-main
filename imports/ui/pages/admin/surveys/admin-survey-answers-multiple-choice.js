...
let _selfAdminSurveyAnswersMultipleChoice
let _subsAdminSurveyAnswersMultipleChoice

Template.AdminSurveyAnswersMultipleChoice.onCreated(function adminSurveyAnswersOnCreated() {
  _selfAdminSurveyAnswersMultipleChoice = this

  _selfAdminSurveyAnswersMultipleChoice.Question = this.data.Question

  Session.set('correctSurveyAnswers', _selfAdminSurveyAnswersMultipleChoice.Question.answer)

  _selfAdminSurveyAnswersMultipleChoice.ready = new ReactiveVar()
  // _selfAdminSurveyAnswersMultipleChoice.qid = new ReactiveVar(_selfAdminSurveyAnswersMultipleChoice.Question._id)
  // _selfAdminSurveyAnswersMultipleChoice.answer= new ReactiveVar(_selfAdminSurveyAnswersMultipleChoice.Question.answer)

  _subsAdminSurveyAnswersMultipleChoice = new SubsManager()

  _selfAdminSurveyAnswersMultipleChoice.autorun(() => {
    // if(_selfAdminSurveyAnswersMultipleChoice.qid.get()) {
      ...
      // let handleSurveyAnswers = _subsAdminSurveyAnswersMultipleChoice.subscribe('training_module_answers_w_qid', _selfAdminSurveyAnswersMultipleChoice.qid.get())
      let handleSurveyAnswers = _subsAdminSurveyAnswersMultipleChoice.subscribe('training_module_answers_w_qid', Session.get('curSQid'))
      _selfAdminSurveyAnswersMultipleChoice.ready.set(handleSurveyAnswers.ready())
    }
  })

})

Template.AdminSurveyAnswersMultipleChoice.onRendered(function adminSurveyAnswersOnRendered() {
...
Template.AdminSurveyAnswersMultipleChoice.helpers({
  answerType() {
  ...
  // Question() {
  //   let myQ =  _selfAdminSurveyAnswersMultipleChoice.Question
  ...
  // correctAnswer() {
  //   console.log(_selfAdminSurveyAnswersMultipleChoice.answer.get())
  //   return _selfAdminSurveyAnswersMultipleChoice.answer.get()
  // },
...
Template.AdminSurveyAnswersMultipleChoice.events({
  'click .btn-add-new-answer'(e, tpl) {
    e.preventDefault()

    // let surveyId = _selfAdminSurveyAnswersMultipleChoice.Question.surveyId
    // let questionId = _selfAdminSurveyAnswersMultipleChoice.Question._id
      ...
      updateQuestionAnswer.call(qObj, (err, res) => {
        if(err) {
          ...
          if(res) {
            ...
            // _selfAdminSurveyAnswersMultipleChoice.answer.set(aids)
          } else {
            toastr.error("Something went wrong. Please try again.")
          }
        }        
...
Template.AdminSurveyAnswersMultipleChoice.onDestroyed(() => {
  Session.set('correctSurveyAnswers', null)
  _subsAdminSurveyAnswersMultipleChoice.clear()
})
