...
let _selfAdminSurveyAnswersStarRating
let _subsAdminSurveyAnswersStarRating

Template.AdminSurveyAnswersStarRating.onCreated(function adminSurveyAnswersOnCreated() {
  _selfAdminSurveyAnswersStarRating = this

  _selfAdminSurveyAnswersStarRating.Question = this.data.Question

  Session.set('correctSurveyAnswers', _selfAdminSurveyAnswersStarRating.Question.answer)

  _selfAdminSurveyAnswersStarRating.ready = new ReactiveVar()
  // _selfAdminSurveyAnswersStarRating.qid = new ReactiveVar(_selfAdminSurveyAnswersStarRating.Question._id)
  // _selfAdminSurveyAnswersStarRating.answer= new ReactiveVar(_selfAdminSurveyAnswersStarRating.Question.answer)

  _subsAdminSurveyAnswersStarRating = new SubsManager()

  _selfAdminSurveyAnswersStarRating.autorun(() => {
    // if(_selfAdminSurveyAnswersStarRating.qid.get()) {
      ...
      // let handleSurveyAnswers = _subsAdminSurveyAnswersStarRating.subscribe('training_module_answers_w_qid', _selfAdminSurveyAnswersStarRating.qid.get())
      let handleSurveyAnswers = _subsAdminSurveyAnswersStarRating.subscribe('training_module_answers_w_qid', Session.get('curSQid'))
      _selfAdminSurveyAnswersStarRating.ready.set(handleSurveyAnswers.ready())
    }
  })

})

Template.AdminSurveyAnswersStarRating.onRendered(function adminSurveyAnswersOnRendered() {
...
Template.AdminSurveyAnswersStarRating.helpers({
  answerType() {
  ...
  // Question() {
  //   let myQ =  _selfAdminSurveyAnswersStarRating.Question
  ...
  // correctAnswer() {
  //   console.log(_selfAdminSurveyAnswersStarRating.answer.get())
  //   return _selfAdminSurveyAnswersStarRating.answer.get()
  // },
...
Template.AdminSurveyAnswersStarRating.events({
  'click .btn-add-new-answer'(e, tpl) {
    e.preventDefault()

    // let surveyId = _selfAdminSurveyAnswersStarRating.Question.surveyId
    // let questionId = _selfAdminSurveyAnswersStarRating.Question._id
      ...
      updateQuestionAnswer.call(qObj, (err, res) => {
        if(err) {
          ...
          if(res) {
            ...
            // _selfAdminSurveyAnswersStarRating.answer.set(aids)
          } else {
            toastr.error("Something went wrong. Please try again.")
          }
        }        
...
Template.AdminSurveyAnswersStarRating.onDestroyed(() => {
  Session.set('correctSurveyAnswers', null)
  _subsAdminSurveyAnswersStarRating.clear()
})
